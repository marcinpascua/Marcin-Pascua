  ...
  return (
    <>
      <SlideUpComponent>
        ...
        >
          <div className="chinpic w-full md:w-1/3 lg:w-1/3 flex items-center justify-center">
            <img src="/chin-pic.png" alt="chin picture" />
          </div>

          <div className="h1 flex flex-col mt-10 font-poppins text-white w-full sm:w-2/3 ">
            <h1 className="text-[150px] md:text-[130px] m-0 ]">
              Hello! I'm
